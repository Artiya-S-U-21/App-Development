...
import './Pro.css';
import kuthiraivaliImage from '/Users/artiya/Documents/app development/app1/src/assets/tamilnadu/kuthiraivali.jpg'; // Adjusted path
...
const Kuthiraivali = () => {
    ...
    <div className="kcard">
        <div className="content">
            <h3>Kuthiraivali (Barnyard Millet)</h3>
            <p>
            ...
            <p>
                ...
                - Kuthiraivali Pongal<br />
                - Kuthiraivali Upma<br />
                - Kuthiraivali Idli<br />
                - Kuthiraivali Kichdi
            </p>
            <p>
                <strong>Recommended Consumption Amount:</strong><br />
                - Adults: 1/2 to 1 cup of cooked Kuthiraivali per day.<br />
                - Children: 1/4 to 1/2 cup of cooked Kuthiraivali per day.<br />
            </p>
            <p>
        ...
        <img src={kuthiraivaliImage} alt="kambu" className="k-image" />
    </div>
</div>
<Footer />
        </>
