...
import chamImage from '/Users/artiya/Documents/app development/app1/src/assets/kerala/chama.jpg'; // Adjusted path
    ...
    <div className="kcard">
        <div className="content">
            ...
            <p>
                ...
                - Adults: 1/2 to 1 cup of cooked Chama per day.<br />
                - Children: 1/4 to 1/2 cup of cooked Chama per day.<br />
            </p>
            <p>
        ...
        <img src={chamImage} alt="kambu" className="k-image" />
    </div>
